...
class LeaderBoard:
    ...
    def update_leader_board_with(self, user_name, game_name, grid_size, winning_tile, is_game_won, num_moves_played,
        ...
        if key not in self._leader_board_details:
            ...
            self._leader_board_details[key][self._KEY_NUM_GAMES_PLAYED] = 0
            self._leader_board_details[key][self._KEY_NUM_GAMES_WON] = 0
            self._leader_board_details[key][self._KEY_NUM_GAMES_LOST] = 0
            self._leader_board_details[key][self._KEY_WIN_RATE] = 0
            self._leader_board_details[key][self._KEY_TOTAL_NUM_MOVES_PLAYED] = 0
            self._leader_board_details[key][self._KEY_TOTAL_NUM_MOVES_PLAYED_IN_WON_GAMES] = 0
            self._leader_board_details[key][self._KEY_TOTAL_NUM_MOVES_PLAYED_IN_LOST_GAMES] = 0
            self._leader_board_details[key][self._KEY_HIGHEST_TILE_REACHED_IN_LOST_GAMES] = None
            self._leader_board_details[key][self._KEY_NUM_MOVES_IN_FASTEST_WIN] = None
            self._leader_board_details[key][self._KEY_NUM_MOVES_IN_SLOWEST_LOSE] = None
            self._leader_board_details[key][self._KEY_HIGHEST_TILE_REACHED_IN_LOST_GAMES_AS_INT] = None
            self._leader_board_details[key][self._KEY_HIGHEST_TILE_REACHED_IN_SLOWEST_LOSE] = None
            self._leader_board_details[key][self._KEY_HIGHEST_TILE_REACHED_IN_SLOWEST_LOSE_AS_INT] = None

        # update with given details
        self._leader_board_details[key][self._KEY_NUM_GAMES_PLAYED] += 1

        if is_game_won:
            self._leader_board_details[key][self._KEY_NUM_GAMES_WON] += 1
            self._leader_board_details[key][self._KEY_TOTAL_NUM_MOVES_PLAYED_IN_WON_GAMES] += num_moves_played
            if self._leader_board_details[key][self._KEY_NUM_MOVES_IN_FASTEST_WIN] is None or \
                    self._leader_board_details[key][self._KEY_NUM_MOVES_IN_FASTEST_WIN] > num_moves_played:
                self._leader_board_details[key][self._KEY_NUM_MOVES_IN_FASTEST_WIN] = num_moves_played
        else:
            self._leader_board_details[key][self._KEY_NUM_GAMES_LOST] += 1
            self._leader_board_details[key][self._KEY_TOTAL_NUM_MOVES_PLAYED_IN_LOST_GAMES] += num_moves_played
            if self._leader_board_details[key][self._KEY_NUM_MOVES_IN_SLOWEST_LOSE] is None or \
                    self._leader_board_details[key][self._KEY_NUM_MOVES_IN_SLOWEST_LOSE] < num_moves_played:
                self._leader_board_details[key][self._KEY_NUM_MOVES_IN_SLOWEST_LOSE] = num_moves_played
                self._leader_board_details[key][self._KEY_HIGHEST_TILE_REACHED_IN_SLOWEST_LOSE] = \
                    highest_tile_reached_if_game_lost
                self._leader_board_details[key][
                    self._KEY_HIGHEST_TILE_REACHED_IN_SLOWEST_LOSE_AS_INT] = tile_str_to_int_function(
                    highest_tile_reached_if_game_lost)

            assert highest_tile_reached_if_game_lost is not None

            current_highest_tile_in_lost_games = self._leader_board_details[key][
                self._KEY_HIGHEST_TILE_REACHED_IN_LOST_GAMES]
            ...
            self._leader_board_details[key][
                self._KEY_HIGHEST_TILE_REACHED_IN_LOST_GAMES] = new_highest_tile_in_lost_games

            self._leader_board_details[key][
                self._KEY_HIGHEST_TILE_REACHED_IN_LOST_GAMES_AS_INT] = tile_str_to_int_function(
                new_highest_tile_in_lost_games)

        self._leader_board_details[key][self._KEY_WIN_RATE] = \
            float(self._leader_board_details[key][self._KEY_NUM_GAMES_WON]) / self._leader_board_details[key][
                self._KEY_NUM_GAMES_PLAYED]

        self._leader_board_details[key][self._KEY_TOTAL_NUM_MOVES_PLAYED] += num_moves_played

        self._save_to_file()

    def _get_key(self, user_name, game_name, grid_size, winning_tile, tile_str_to_int_conversion):
        """
        :type user_name: str
        :type game_name: str
        :type grid_size: int
        ...
        :rtype: str
        """
        return self._SEPARATOR_IN_LEADER_BOARD_KEYS.join((user_name, game_name, str(grid_size), str(winning_tile),
    ...
    def _split_key(self, key):
        ...
        :rtype: tuple[str]
        """
        return key.split(self._SEPARATOR_IN_LEADER_BOARD_KEYS)
